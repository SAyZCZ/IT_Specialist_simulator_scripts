# Read paper_cost, toner_cost, delivery_cost and budget from the console.
# Calculate total_cost and remaining_budget.
# Print both results.
...
paper_cost = float(input())    # paper cost,
toner_cost = float(input())    #toner cost,
delivery_cost = float(input())  # delivery cost,
...
print(total_cost, remaining_budget)
